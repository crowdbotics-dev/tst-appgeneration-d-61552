...
## Project Structure
    ...
    ├── tst_appgeneration_d_61552  # Django project configurations
...
1. Clone this repo and `cd tst_appgeneration_d_61552`
...
2. Clone this repo and `cd tst_appgeneration_d_61552`
